...
const XEyesElement = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    attachShadow(this);
...
const XEyes = /*@__PURE__*/proxyCustomElement(XEyesElement, [1,"x-eyes",{"delay":[514],"distance":[514],"position":[520],"radius":[513],"reset":[516]}]);
...
export { XEyes, defineCustomElements };
