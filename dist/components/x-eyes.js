...
const XEyesElement = /*@__PURE__*/ proxyCustomElement(class XEyesElement extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.resetPositionEvent = createEvent(this, "resetposition", 7);
    this.delay = 0;
    this.distance = 0;
  ...
  rightEye;
  render() {
    return h(Host, null, h("div", { class: "eye" }, h("div", { class: "iris", ref: el => this.leftIrisEl = el })), h("div", { class: "eye" }, h("div", { class: "iris", ref: el => this.rightIrisEl = el })));
  }
  /**
  ...
  static get style() { return xEyesCss; }
}, [1, "x-eyes", {
    "delay": [514],
    "distance": [514],
    "position": [520],
...
function defineCustomElement$1() {
  ...
  const components = ["x-eyes"];
  components.forEach(tagName => { switch (tagName) {
    case "x-eyes":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, XEyesElement);
      }
      break;
  } });
}

const XEyes = XEyesElement;
const defineCustomElement = defineCustomElement$1;

export { XEyes, defineCustomElement };

//# sourceMappingURL=x-eyes.js.map