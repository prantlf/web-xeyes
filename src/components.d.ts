...
export namespace Components {
    interface XEyes {
        ...
        "reset": boolean;
        /**
          * Enables the eye pupil to follow the mouse cursor movements. This happens automatically after inserting the element and can be changed by calling `stopFollowing`.
         */
        "startFollowing": () => Promise<boolean>;
        /**
          * Disables the eye pupil to follow the mouse cursor movements. The mouse cursor movements can be followed again by calling `startFollowing`.
         */
